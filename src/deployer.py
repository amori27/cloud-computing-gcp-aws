...
class CloudDeployer:
    ...
    def deploy_infrastructure(
        self, environment: str, tf_dir: str = "."
    ) -> dict[str, Any]:
...
def deploy_gcp_function(
    project_id: str, function_name: str, region: str = "us-central1"
) -> dict[str, Any]:
...
def deploy_lambda_function(
    function_name: str, zip_path: str, role_arn: str
) -> dict[str, Any]:
